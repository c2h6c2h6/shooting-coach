...
export const confirmationTestCatalog:ConfirmationTestDefinition[]=[
 ...
 {code:"TEST_EQUIPMENT_CONTEXT_CHECK",hypothesisCodes:["EQUIPMENT_OR_SIGHT_ISSUE","UNFAMILIAR_EQUIPMENT"],
  category:"context_equipment",title:"Vérification rapide avant d’examiner la technique",
  ...
  instructions:["Vous visiez bien le point prévu.","Rien d’anormal n’est visible sur les organes de visée.","Vous n’avez pas changé d’arme, de réglage ou de configuration depuis la série."],
  observationCriteria:["Tout correspond à ce que j’ai réellement fait","Les informations de la séance ne correspondent pas à la réalité",
   "Je ne visais pas le point prévu","J’ai un doute sur le réglage ou le matériel",
   "Je préfère faire vérifier l’arme ou les organes de visée","Je ne peux pas conclure"],
