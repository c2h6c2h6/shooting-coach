...
export const observationHypothesisMappings:ObservationHypothesisMapping[]=[
  m("OFFSET_LEFT","LATERAL_TRIGGER_PRESSURE",3),m("OFFSET_LEFT","UNBALANCED_HAND_PRESSURE",2),
  m("OFFSET_LEFT","SIGHT_ALIGNMENT_VARIATION",2),m("OFFSET_LEFT","EQUIPMENT_OR_SIGHT_ISSUE",2),
  m("OFFSET_RIGHT","LATERAL_TRIGGER_PRESSURE",3),m("OFFSET_RIGHT","UNBALANCED_HAND_PRESSURE",2),
  ...
  ...(["OFFSET_HIGH","OFFSET_LOW","OFFSET_HIGH_LEFT","OFFSET_HIGH_RIGHT","OFFSET_LOW_LEFT","OFFSET_LOW_RIGHT"] as ObservationCode[])
    .flatMap(o=>[m(o,"SIGHT_ALIGNMENT_VARIATION",3),m(o,"UNBALANCED_HAND_PRESSURE",2),
      m(o,o.includes("LOW")?"SHOT_ANTICIPATION":"SIGHT_PICTURE_VARIATION",2),m(o,"EQUIPMENT_OR_SIGHT_ISSUE",1)]),
  m("HORIZONTAL_SPREAD","INCONSISTENT_TRIGGER_PRESS",3),m("HORIZONTAL_SPREAD","SIGHT_ALIGNMENT_VARIATION",2),
  m("HORIZONTAL_SPREAD","UNBALANCED_HAND_PRESSURE",2),m("HORIZONTAL_SPREAD","POSTURAL_SWAY",1),
  ...
  m("TWO_AXIS_SPREAD","INCONSISTENT_GRIP_PRESSURE",3),m("TWO_AXIS_SPREAD","UNSTABLE_STANCE",2),
  ...
  m("COMPACT_BUT_OFFSET","UNBALANCED_HAND_PRESSURE",2),
  ...
  m("CENTERED_BUT_DISPERSED","POSTURAL_SWAY",2),
  m("OUTLIER_TO_VERIFY","ABRUPT_TRIGGER_PRESS",2,{minimumImpacts:3}),m("OUTLIER_TO_VERIFY","SHOT_ANTICIPATION",1,{minimumImpacts:3}),
