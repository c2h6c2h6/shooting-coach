...
const historical={
 ...
 D:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
 ...
 F:{shape:"both_axes",observations:["OUTLIER_TO_VERIFY","CENTERED_AND_COMPACT","CENTERED","COMPACT_GROUP","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["ATTENTION_LOSS","SHOT_ANTICIPATION"]},
 G:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
 ...
 I:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
 J:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
 K:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
