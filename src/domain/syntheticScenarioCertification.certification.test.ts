...
const historical={
 ...
 C:{shape:"vertical",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","VERTICAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","BREATHING_DISRUPTION"]},
 ...
 H:{shape:"vertical",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","VERTICAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","BREATHING_DISRUPTION"]},
