...
const historical={
 ...
 C:{shape:"vertical",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","VERTICAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","BREATHING_DISRUPTION","POSTURAL_SWAY"]},
 D:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","INCONSISTENT_TRIGGER_PRESS","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
 E:{shape:"both_axes",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
 F:{shape:"both_axes",observations:["OUTLIER_TO_VERIFY","CENTERED_AND_COMPACT","CENTERED","COMPACT_GROUP","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["ABRUPT_TRIGGER_PRESS","ATTENTION_LOSS","SHOT_ANTICIPATION"]},
 G:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","INCONSISTENT_TRIGGER_PRESS","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
 H:{shape:"vertical",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","VERTICAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","SIGHT_ALIGNMENT_VARIATION","BREATHING_DISRUPTION","POSTURAL_SWAY"]},
 I:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","INCONSISTENT_TRIGGER_PRESS","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
 J:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","INCONSISTENT_TRIGGER_PRESS","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
 K:{shape:"horizontal",observations:["CENTERED_BUT_DISPERSED","CENTERED","WIDE_GROUP","HORIZONTAL_SPREAD","MANUAL_INPUT_LIMITATION","TARGET_GEOMETRY_UNVERIFIED"],hypotheses:["INCONSISTENT_GRIP_PRESSURE","INCONSISTENT_TRIGGER_PRESS","SIGHT_ALIGNMENT_VARIATION","POSTURAL_SWAY"]},
